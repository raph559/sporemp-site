...
for (const [lang, data] of [['en',english],['fr',french]]) {
  ...
  const footer = c => `<footer class="footer wrap"><a class="brand" href="${c.prefix}">spore<span>mp</span></a><p>${t.footer}</p><a href="${c.prefix}#project">${t.backProject}</a><div class="fineprint">${t.rights}<br>${t.artNotice}</div></footer>`;
